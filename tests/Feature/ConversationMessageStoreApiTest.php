...
class ConversationMessageStoreApiTest extends TestCase
{
    ...
    public function test_should_not_store_the_message_if_content_is_not_a_string()
    {
        $me = User::factory()->create();
        $contact = User::factory()->create();
    ...
    public function test_should_not_store_the_message_if_initial_message_id_does_not_exist()
    {
        $me = User::factory()->create();
        $contact = User::factory()->create();
