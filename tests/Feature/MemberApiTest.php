...
class MemberApiTest extends TestCase
{
    ...
    public function test_if_full_name_parameter_is_empty_string_filter_should_return_an_empty_data_list()
    {
        $me = User::factory()->create(['firstname' => 'John', 'lastname' => 'Doe']);
        User::factory()->create(['firstname' => 'Stefan', 'lastname' => 'Salvatore']);

        $response = $this->actingAs($me)->getJson(route('members.index', ['full_name' => ""]));
